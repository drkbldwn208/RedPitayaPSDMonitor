...
#define XPSDMONITORTOP_CTRL_ADDR_AP_CTRL          0x00
#define XPSDMONITORTOP_CTRL_ADDR_GIE              0x04
#define XPSDMONITORTOP_CTRL_ADDR_IER              0x08
#define XPSDMONITORTOP_CTRL_ADDR_ISR              0x0c
