...
set portList { 
	...
	{ adc_in_TDATA sc_in sc_lv 32 signal 1 } 
	{ adc_in_TVALID sc_in sc_logic 1 invld 4 } 
	{ adc_in_TREADY sc_out sc_logic 1 inacc 4 } 
	{ adc_in_TKEEP sc_in sc_lv 4 signal 2 } 
	{ adc_in_TSTRB sc_in sc_lv 4 signal 3 } 
	{ adc_in_TLAST sc_in sc_lv 1 signal 4 } 
...
set NewPortList {[ 
	...
	{ "name": "s_axi_CTRL_BRESP", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "CTRL", "role": "BRESP" } }, 
 	...
 	{ "name": "adc_in_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "adc_in_V_last_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	adc_in_V_data_V { axis {  { adc_in_TDATA in_data 0 32 } } }
	adc_in_V_keep_V { axis {  { adc_in_TKEEP in_data 0 4 } } }
	adc_in_V_strb_V { axis {  { adc_in_TSTRB in_data 0 4 } } }
	adc_in_V_last_V { axis {  { adc_in_TVALID in_vld 0 1 }  { adc_in_TREADY in_acc 1 1 }  { adc_in_TLAST in_data 0 1 } } }
}
