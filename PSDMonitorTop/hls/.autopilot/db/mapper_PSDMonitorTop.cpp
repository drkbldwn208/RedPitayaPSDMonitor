...
unsigned int ap_apatb_adc_in_V_data_V_cap_bc;
static AESL_RUNTIME_BC __xlx_adc_in_V_data_V_V_size_Reader("../tv/stream_size/stream_size_in_adc_in_V_data_V.dat");
unsigned int ap_apatb_adc_in_V_keep_V_cap_bc;
static AESL_RUNTIME_BC __xlx_adc_in_V_keep_V_V_size_Reader("../tv/stream_size/stream_size_in_adc_in_V_keep_V.dat");
unsigned int ap_apatb_adc_in_V_strb_V_cap_bc;
static AESL_RUNTIME_BC __xlx_adc_in_V_strb_V_V_size_Reader("../tv/stream_size/stream_size_in_adc_in_V_strb_V.dat");
...
__xlx_ram_buffer__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_ram_buffer)[i]);
}
  int __xlx_size_param_ram_buffer = 2000000;
  int __xlx_offset_param_ram_buffer = 0;
  int __xlx_offset_byte_param_ram_buffer = 0*2;
auto* sadc_in_V_data_V = createStream((hls::stream<int>*)__xlx_apatb_param_adc_in_V_data_V);
auto* sadc_in_V_keep_V = createStream((hls::stream<char>*)__xlx_apatb_param_adc_in_V_keep_V);
...
sadc_in_V_data_V->transfer((hls::stream<int>*)__xlx_apatb_param_adc_in_V_data_V);
sadc_in_V_keep_V->transfer((hls::stream<char>*)__xlx_apatb_param_adc_in_V_keep_V);
sadc_in_V_strb_V->transfer((hls::stream<char>*)__xlx_apatb_param_adc_in_V_strb_V);
sadc_in_V_last_V->transfer((hls::stream<char>*)__xlx_apatb_param_adc_in_V_last_V);
}
